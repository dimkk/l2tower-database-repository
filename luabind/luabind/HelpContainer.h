...
namespace TowerLua
{
	...
	#define HELP_EVENT(ptr, index, type)		static TowerLua::HelpNavigator TowerLua__JOIN(g_helpMarker,__COUNTER__)("EVENT", typeid(ptr).name(), index, typeid(type).name(), __FILE__, __LINE__, TowerLua::void_cast(ptr));
