...
call :colors 17
set cmdline="%mysqlPath%" -h %lshost% -u %lsuser% --password=%lspass% -e "DROP DATABASE %lsdb%" 2^> NUL
%cmdline%
set cmdline="%mysqlPath%" -h %lshost% -u %lsuser% --password=%lspass% -e "CREATE DATABASE %lsdb%" 2^> NUL
%cmdline%

set cmdline="%mysqlPath%" -h %lshost% -u %lsuser% --password=%lspass% -e "DROP DATABASE %gsdb%" 2^> NUL
%cmdline%
set cmdline="%mysqlPath%" -h %lshost% -u %lsuser% --password=%lspass% -e "CREATE DATABASE %gsdb%" 2^> NUL
%cmdline%

set cmdline="%mysqlPath%" -h %lshost% -u %lsuser% --password=%lspass% -e "DROP DATABASE %csdb%" 2^> NUL
%cmdline%
set cmdline="%mysqlPath%" -h %lshost% -u %lsuser% --password=%lspass% -e "CREATE DATABASE %csdb%" 2^> NUL
%cmdline%
...
set cmdline="%mysqlPath%" -h %cbhost% -u %cbuser% --password=%cbpass% -e "DROP DATABASE %cbdb%" 2^> NUL
%cmdline%
...
set cmdline="%mysqlPath%" -h %gshost% -u %gsuser% --password=%gspass% -e "DROP DATABASE %gsdb%" 2^> NUL
%cmdline%
...
for %%i in (.\updates\*.sql) do echo "%mysqlPath%" -h %gshost% -u %gsuser% --password=%gspass% -D %gsdb% --force ^< %%i 2^>^> gs_errors.txt >> temp.bat
call temp.bat> nul
del temp.bat
...
for %%i in (.\custom\*.sql) do echo "%mysqlPath%" -h %gshost% -u %gsuser% --password=%gspass% -D %gsdb% ^< %%i 2^>^> custom_errors.txt >> temp.bat
call temp.bat> nul
del temp.bat
...
for %%i in (.\mods\*.sql) do echo "%mysqlPath%" -h %gshost% -u %gsuser% --password=%gspass% -D %gsdb% ^< %%i 2^>^> mods_errors.txt >> temp.bat
call temp.bat> nul
del temp.bat
